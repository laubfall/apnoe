...
public class ByExtendedTypeScanner extends ByTypeScanner
{
  ...
  public boolean match(InputStream artifact)
  {
    ...
    try {
      final List<ResolvedReferenceType> ancestors = javaParserFacade.getTypeDeclaration(typeDeclaration)
          .getAllAncestors();
      ...
      LOG.warn("Failed to resolve type ancestor in matcher for artifact: " + parsedArtifact, e);
    }
    return false;
  }
